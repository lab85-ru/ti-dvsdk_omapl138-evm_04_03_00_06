...
// PSLvolt_reg.c
// 
// Source file containing default PSL implementation for PSL voltage
...
//   
//-----------------------------------------------------------------------------
void PSL_gpioVoltRegScale(float currVoltage,
                          float newVoltage,
                          float currFrequency,
                          int   wait) {
