...
)
{
    ...
    (Needs to be changed everytime we make a API call)*/
    InArg_Buf_size=  sizeof(Fxn_struct)+
                     sizeof(IMG_thr_gt2thr_8_Params)+
                     sizeof(CInArgs->size)+
                     sizeof(CInArgs->Num_fxns);
    ...
    /* Initialize pointers to function parameters */
    fp0 = (IMG_thr_gt2thr_8_Params *)((XDAS_Int8*)CInArgs + CInArgs->fxn[0].Param_ptr_offset);
...
int C6accel_IMG_conv_7x7_i8_c8s (C6accel_Handle hC6accel,
                                  ...
                                  short            shift)
{
    ...
    int status;
    /* Define pointer to function parameter structure */
    IMG_conv_7x7_i8_c8s_Params  *fp0;
    XDAS_Int8 *pAlloc;
    ...
    (Needs to be changed everytime we make a API call)*/
    InArg_Buf_size=  sizeof(Fxn_struct)+
                     sizeof(IMG_conv_7x7_i8_c8s_Params)+
                     sizeof(CInArgs->size)+
                     sizeof(CInArgs->Num_fxns);
    ...
    outBufDesc.numBufs = 1;
     ...
     /* Fill in input/output buffer descriptor parameters and manage ARM cache*/
    /* See wrapper_c6accel_i.h for more details of operation                 */
    CACHE_WB_INV_INPUT_BUFFERS_AND_SETUP_FOR_C6ACCEL(imgin_ptr,0,width*7*sizeof(char));
    CACHE_WB_INV_INPUT_BUFFERS_AND_SETUP_FOR_C6ACCEL(mask_ptr,1,(7*7)*sizeof(char));
    CACHE_INV_OUTPUT_BUFFERS_AND_SETUP_FOR_C6ACCEL(imgout_ptr,0,width*sizeof(char));
    ...
    /* Set function Id and parameter pointers for first function call */
    CInArgs->fxn[0].FxnID= IMG_CONV_7X7_I8_C8S_FXN_ID;
    CInArgs->fxn[0].Param_ptr_offset=sizeof(CInArgs->size)+sizeof(CInArgs->Num_fxns)+sizeof(Fxn_struct);

    /* Initialize pointers to function parameters */
    fp0 = (IMG_conv_7x7_i8_c8s_Params *)((XDAS_Int8*)CInArgs+CInArgs->fxn[0].Param_ptr_offset);
...
*/
int C6accel_IMG_conv_7x7_i8_c8s_frame (C6accel_Handle hC6accel,
                                  const unsigned char *restrict imgin_ptr,
                                  unsigned char *restrict imgout_ptr,
                                  short            height,
                                  short            width,
                                  ...
                                  short            shift)
{
    ...
    int status;
    /* Define pointer to function parameter structure */
    IMG_conv_7x7_i8_c8s_frame_Params  *fp0;
    XDAS_Int8 *pAlloc;
    ...
    (Needs to be changed everytime we make a API call)*/
    InArg_Buf_size=  sizeof(Fxn_struct)+
                     sizeof(IMG_conv_7x7_i8_c8s_frame_Params)+
                     sizeof(CInArgs->size)+
                     sizeof(CInArgs->Num_fxns);
    ...
    outBufDesc.numBufs = 1;
     ...
     /* Fill in input/output buffer descriptor parameters and manage ARM cache*/
    /* See wrapper_c6accel_i.h for more details of operation                 */
    CACHE_WB_INV_INPUT_BUFFERS_AND_SETUP_FOR_C6ACCEL(imgin_ptr,0,width*height*sizeof(char));
    CACHE_WB_INV_INPUT_BUFFERS_AND_SETUP_FOR_C6ACCEL(mask_ptr,1,(7*7)*sizeof(char));
    CACHE_INV_OUTPUT_BUFFERS_AND_SETUP_FOR_C6ACCEL(imgout_ptr,0,width*height*sizeof(char));
    ...
    /* Set function Id and parameter pointers for first function call */
    CInArgs->fxn[0].FxnID= IMG_CONV_7X7_I8_C8S_FRAME_FXN_ID;
    CInArgs->fxn[0].Param_ptr_offset=sizeof(CInArgs->size)+sizeof(CInArgs->Num_fxns)+sizeof(Fxn_struct);

    /* Initialize pointers to function parameters */
    fp0 = (IMG_conv_7x7_i8_c8s_frame_Params *)((XDAS_Int8*)CInArgs+CInArgs->fxn[0].Param_ptr_offset);
