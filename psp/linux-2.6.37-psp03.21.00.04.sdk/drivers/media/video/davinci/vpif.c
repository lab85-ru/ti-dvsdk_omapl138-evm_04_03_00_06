				...
				u8 channel_id, u8 found)
{
	...
	for (i = start; i < end; i++) {
		...
		vpifparams->video_params.hpitch = vpifparams->video_params.hpitch * 2;
		printk(KERN_ERR "FIX MY:= vpifparams->video_params.hpitch*2 (for PAL UYVY No:yyyyy cbcbcbcb) = %d\n",vpifparams->video_params.hpitch);
