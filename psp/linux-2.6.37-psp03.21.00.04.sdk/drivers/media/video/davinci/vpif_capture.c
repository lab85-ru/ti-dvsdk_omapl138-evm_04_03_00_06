...
static const struct vpif_channel_config_params ch_params[] = {
	...
	{
// My fix No separate Y <-> CB CR !!!
//		"PAL_BDGHIK", 720, 576, 25, 0, 1, 280, 1440, 1, 23, 311, 313,
		"PAL_BDGHIK", 720, 576, 25, 0, 0, 280, 1440, 1, 23, 311, 313,
...
static void vpif_calculate_offsets(struct channel_obj *ch)
{
	...
	if ((V4L2_FIELD_NONE == vid_ch->buf_field) ||
		...
		printk(KERN_ERR "FIX MY:vpif_calculate_offsets : 1\n");
		/* Calculate offsets for Y top, Y Bottom, C top and C Bottom */
		common->ytop_off = 0;
		common->ybtm_off = hpitch * 2;
		common->ctop_off = 0;//sizeimage / 2;
		common->cbtm_off = 0;//sizeimage / 2 + hpitch;

		printk(KERN_ERR "FIX MY:For UYVY ytop_off=%d ybtm_off=%d ctop_off=%d cbtm_off=%d\n",
		common->ytop_off,
		common->ybtm_off,
		common->ctop_off,
		common->cbtm_off );
