...
#define __GMP_CC "arm-arago-linux-gnueabi-gcc -march=armv5te -mtune=arm926ej-s -mthumb-interwork -mno-thumb --sysroot=/OE/arago-tmp/sysroots/armv5te-arago-linux-gnueabi -std=gnu99"
#define __GMP_CFLAGS "-fexpensive-optimizations -frename-registers -fomit-frame-pointer -O2 -ggdb2"
