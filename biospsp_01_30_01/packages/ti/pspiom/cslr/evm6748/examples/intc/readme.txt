INTC CSL EXAMPLE
====================
The folders in this directory contain a example that demonstrates the usage of 
DSP INTC CSL

Example Description:
---------------------
This example initializes the DSP Interrupt controller using CSL macros. The same
