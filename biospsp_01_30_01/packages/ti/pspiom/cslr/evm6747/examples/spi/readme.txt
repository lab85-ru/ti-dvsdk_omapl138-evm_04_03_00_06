SPI CSL EXAMPLE
====================
The folders in this directory contain a register layer example for SPI

Example Description:
--------------------
This example initializes the SPI peripheral in looback mode using CSL macros.
This is verified by comparing the trasmit and receive data using CSl macros.
...
2. Open the Spi_example.pjt in the CCS
