 ...
 *  @leave  None.
 *
 *  @see    DM6446GEM_setup, DM6446GEM_exit
 *  ----------------------------------------------------------------------------
 */
NORMAL_API
DSP_STATUS
DM6446GEM_init (IN ProcessorId  dspId, IN DSP_Object * dspState) ;
...
NORMAL_API
DSP_STATUS
DM6446GEM_exit (IN ProcessorId dspId, IN DSP_Object * dspState) ;


/** ----------------------------------------------------------------------------
 *  @func   DM6446GEM_start
 *
...
NORMAL_API
DSP_STATUS
DM6446GEM_start (IN ProcessorId  dspId,
...
NORMAL_API
DSP_STATUS
DM6446GEM_stop (IN ProcessorId dspId, IN DSP_Object * dspState) ;
...
NORMAL_API
DSP_STATUS
DM6446GEM_idle (IN ProcessorId dspId, IN DSP_Object * dspState) ;


/** ----------------------------------------------------------------------------
 *  @func   DM6446GEM_intCtrl
 *
...
NORMAL_API
DSP_STATUS
DM6446GEM_intCtrl (IN         ProcessorId       dspId,
                   IN         DSP_Object     *  dspState,
                   IN         Uint32            intId,
...
NORMAL_API
DSP_STATUS
DM6446GEM_read (IN  ProcessorId  dspId,
                IN  DSP_Object * dspState,
                IN  Uint32       dspAddr,
...
NORMAL_API
DSP_STATUS
DM6446GEM_write (IN ProcessorId  dspId,
                 IN DSP_Object * dspState,
                 IN Uint32       dspAddr,
                 IN Endianism    endianInfo,
                 IN Uint32       numBytes,
...
NORMAL_API
Uint32
DM6446GEM_addrConvert (IN  ProcessorId        dspId,
                       IN  DSP_Object *       dspState,
                       IN  Uint32             addr,
...
NORMAL_API
DSP_STATUS
DM6446GEM_control (IN  ProcessorId  dspId,
                   IN  DSP_Object * dspState,
                   IN  Int32        cmd,
                       Pvoid        arg) ;
...
/** ============================================================================
 *  @name   DM6446GEM_Interface
 *
 *  @desc   The interface table exposed for the DSP component.
 *  ============================================================================
 */
DSP_Interface DM6446GEM_Interface = {
    &DM6446GEM_init,
    &DM6446GEM_exit,
    &DM6446GEM_start,
    &DM6446GEM_stop,
...
DM6446GEM_init (IN ProcessorId  dspId, IN DSP_Object * dspState)
{
    ...
    TRC_2ENTER ("DM6446GEM_init", dspId, dspState) ;
    ...
    if (IS_VALID_PROCID (dspId) == FALSE) {
        ...
        if (     (dspObj->doDspCtrl != DSP_BootMode_Boot_Pwr)
            ...
            if (DSP_SUCCEEDED (status)) {
                status = DM6446GEM_halInit (&dspState->halObject, NULL) ;
                if (DSP_FAILED (status)) {
                    SET_FAILURE_REASON ;
                }
                else  {
                    halObj = (DM6446GEM_HalObj *) dspState->halObject ;
                }
            }
    ...
    TRC_1LEAVE ("DM6446GEM_init", status) ;
 ...
 *          2. Call DM6446GEM_idle () to let the DSP run in 'self loop'.
...
DM6446GEM_exit (IN ProcessorId dspId, IN DSP_Object * dspState)
{
    ...
    LINKCFG_Dsp *       dspObj           ;
    LINKCFG_MemEntry *  memTable         ;
    DM6446GEM_HalObj *  halObj           ;
    LINKCFG_DspConfig * dspCfg           ;
    Uint32              i                ;

    TRC_2ENTER ("DM6446GEM_exit", dspId, dspState) ;
    ...
    if (IS_VALID_PROCID (dspId) == FALSE) {
        ...
        if (dspState->halObject != NULL) {
            ...
            DM6446GEM_halExit (&dspState->halObject) ;
        }
    }

    TRC_1LEAVE ("DM6446GEM_exit", status) ;
                  ...
                  IN Uint32       dspAddr)
{
    ...
    TRC_3ENTER ("DM6446GEM_start", dspId, dspState, dspAddr) ;
    ...
    TRC_1LEAVE ("DM6446GEM_start", status) ;
...
DM6446GEM_stop (IN ProcessorId dspId, IN DSP_Object * dspState)
{
    ...
    TRC_2ENTER ("DM6446GEM_stop", dspId, dspState) ;
    ...
    TRC_1LEAVE ("DM6446GEM_stop", status) ;
...
DM6446GEM_idle (IN ProcessorId dspId, IN DSP_Object * dspState)
{
    ...
    TRC_2ENTER ("DM6446GEM_idle", dspId, dspState) ;
    ...
    TRC_1LEAVE ("DM6446GEM_idle", status) ;
                   ...
                   IN OUT     Pvoid             arg)
{
    ...
    TRC_5ENTER ("DM6446GEM_intCtrl", dspId, dspState, intId, cmd, arg) ;
    ...
    TRC_1LEAVE ("DM6446GEM_intCtrl", status) ;
                 ...
                 OUT Uint8 *      buffer)
{
    ...
    TRC_1LEAVE ("DM6446GEM_read", status) ;
                  ...
                  IN Uint8 *       buffer)
{
    ...
    TRC_1LEAVE ("DM6446GEM_write", status) ;
                        ...
                        IN  DSP_AddrConvType   type)
{
    ...
    TRC_4ENTER ("DM6446GEM_addrConvert", dspId, dspState, addr, type) ;
    ...
    TRC_2PRINT (TRC_LEVEL1,
                "DM6446GEM_addrConvert addr [0x%x] convAddr [0x%x]\n",
                addr,
                convAddr) ;

    TRC_0LEAVE ("DM6446GEM_addrConvert") ;
                        ...
                        Pvoid       arg)
{
    ...
    TRC_4ENTER ("DM6446GEM_control", dspId, dspState, cmd, arg) ;

    DBC_Require (IS_VALID_PROCID (dspId)) ;

    status = DSP_ENOTIMPL ;

    TRC_1LEAVE ("DM6446GEM_control", status) ;
