...
/** ============================================================================
 *  @name   DM6446GEMMAP_DspObjects
 *
 *  @desc   Array of configuration mapping objects for the DSPs in the system.
 *  ============================================================================
 */
EXTERN DSP_Interface    DM6446GEM_Interface ;
CONST CFGMAP_Dsp  DM6446GEMMAP_DspObjects [] =
{
    {
        "DM6446GEM",                  /* NAME           : Name of the DSP */
        &DM6446GEM_Interface          /* INTERFACE      : DSP interface table */
    }
} ;

/** ============================================================================
 *  @name   DM6446GEMMAP_LoaderObjects
 *
...
CONST CFGMAP_Loader  DM6446GEMMAP_LoaderObjects [] =
{
    {
...
/** ============================================================================
 *  @name   DM6446GEMMAP_LinkDrvObjects
 *
...
CONST CFGMAP_LinkDrv  DM6446GEMMAP_LinkDrvObjects [] =
{
    {
...
CONST CFGMAP_Ips  DM6446GEMMAP_IpsObjects [] =
{
    {
...
CONST CFGMAP_Pool  DM6446GEMMAP_PoolObjects [] =
{
    {
...
/** ============================================================================
 *  @name   DM6446GEMMAP_DataDrvObjects
 *
...
CONST CFGMAP_DataDrv  DM6446GEMMAP_DataDrvObjects [] =
{
    {
...
CONST CFGMAP_Mqt  DM6446GEMMAP_MqtObjects [] =
{
    {
...
/** ============================================================================
 *  @name   DM6446GEMMAP_Config
 *
 *  @desc   DSP/BIOS LINK configuration mapping structure.
 *  ============================================================================
 */
CFGMAP_Object  DM6446GEMMAP_Config = {
    1,                                              /* NUMDSPS        : Number of types of DSPs */
    (CFGMAP_Dsp *)     DM6446GEMMAP_DspObjects,     /* DSPOBJECTS     : Array of DSP configuration mapping objects */
#if defined (OS_PROS)
...
#endif /* if defined (OS_PROS) */
    (CFGMAP_Loader *)  DM6446GEMMAP_LoaderObjects,  /* LOADERS        : Array of DSP executable loader configuration mapping objects */

#if (!defined (ONLY_PROC_COMPONENT))
    1,                                              /* NUMLINKDRVS    : Number of types of link drivers */
    (CFGMAP_LinkDrv *) DM6446GEMMAP_LinkDrvObjects, /* LINKDRVOBJECTS : Array of Link Driver configuration mapping objects */
    1,                                              /* NUMIPS         : Number of types of IPS */
    (CFGMAP_Ips *)     DM6446GEMMAP_IpsObjects,     /* IPSOBJECTS     : Array of IPS configuration mapping objects */
#else
    ...
    (CFGMAP_Pool *)    DM6446GEMMAP_PoolObjects,    /* POOLOBJECTS    : Array of POOL configuration mapping objects */
#endif /* if defined (POOL_COMPONENT) */
#if defined (CHNL_COMPONENT)
    1,                                              /* NUMDATADRIVERS : Number of types of Data drivers */
    (CFGMAP_DataDrv *) DM6446GEMMAP_DataDrvObjects, /* DATADRIVERS    : Array of Data driver configuration mapping objects */
#endif /* if defined (CHNL_COMPONENT) */
#if defined (MSGQ_COMPONENT)
    1,                                              /* NUMMQTS        : Number of types of MQTs */
    (CFGMAP_Mqt *)     DM6446GEMMAP_MqtObjects      /* MQTOBJECTS     : Array of MQT configuration mapping objects */
#endif /* if defined (MSGQ_COMPONENT) */
} ;
