...
#if (DM6467GEM_PHYINTERFACE == SHMEM_INTERFACE)
#include <dm6467gem_phy_shmem.h>
#endif /* if (DM6467GEM_PHYINTERFACE == SHMEM_INTERFACE) */
                   ...
                   IN     Pvoid   initParams)
{
    ...
    DM6467GEM_HalObj * halObject ;

    TRC_2ENTER ("DM6467GEM_halInit", halObj, initParams) ;
...
#if (DM6467GEM_PHYINTERFACE == SHMEM_INTERFACE)
        halObject->interface = &DM6467GEM_shmemInterface ;
#endif /* if (DM6467GEM_PHYINTERFACE == SHMEM_INTERFACE) */
    ...
    TRC_1LEAVE ("DM6467GEM_halInit", status) ;
...
DM6467GEM_halExit (IN     Pvoid * halObj)
{
    ...
    TRC_1ENTER ("DM6467GEM_halExit", halObj) ;
    ...
    TRC_1LEAVE ("DM6467GEM_halExit", status) ;
