...
NORMAL_API
DSP_STATUS
DM6437_halPciBootCtrl (IN         Pvoid           halObj,
                       ...
                       IN OUT     Pvoid           arg)
{
    ...
    TRC_3ENTER ("DM6437_halPciBootCtrl", halObj, cmd, arg) ;
    ...
    TRC_1LEAVE ("DM6437_halPciBootCtrl", status) ;
