...
/*  ----------------------------------------------------------------------------
 *  @func   DM6437_halPciPwrChangeState
 *
...
NORMAL_API
Void
DM6437_halPciPwrChangeState (IN Pvoid           halObj,
                             IN Uint32          lpscNum,
                             IN Uint16          state);


/*  ----------------------------------------------------------------------------
 *  @func   DM6437_halPciPwrCfgPLL1
 *
...
NORMAL_API
Void
DM6437_halPciPwrCfgPLL1 (IN Pvoid           halObj,
                         IN Uint32          pllm,
                         IN Uint32          div1,
                         IN Uint32          div2) ;
...
NORMAL_API
Void
DM6437_halPciPwrCfgDDR2 (IN Pvoid halObj, IN Uint32  freq) ;


/** ============================================================================
 *  @func   DM6437_halPciPwrCtrl
 *
...
NORMAL_API
DSP_STATUS
DM6437_halPciPwrCtrl (IN         Pvoid          halObj,
                      ...
                      IN OUT     Pvoid          arg)
{
    ...
    TRC_3ENTER ("DM6437_halPciPwrCtrl", halObj, cmd, arg) ;

    DBC_Require (NULL != halObject) ;

    (Void) arg ;

    pscRegs  = (DM6437_pscRegs *) (  halObject->pci.barVirt [CFG_REGS_BAR_NO]
                                   + DM6437_PSCREG_BASE) ;
    switch (cmd) {
        case DSP_PwrCtrlCmd_PeripheralUp:
        {
            /* Enable the DDR2 PSC Module */
            DM6437_halPciPwrChangeState (halObject, LPSC_DDR, 0x3) ;

            /* Programme the PLL1 (DDR2) to run at higher frequency. */
            DM6437_halPciPwrCfgPLL1 (halObject, 23, 11, 1) ;

            /* Programme the DDR PHY register corresponding to PLL1
             * frequency.
             */
            DM6437_halPciPwrCfgDDR2 (halObject, 162) ;

            /* Enable EDMA module*/
            DM6437_halPciPwrChangeState (halObject, LPSC_EDMA_TPCC, 0x3) ;
            DM6437_halPciPwrChangeState (halObject, LPSC_EDMA_TPTC0, 0x3) ;
            DM6437_halPciPwrChangeState (halObject, LPSC_EDMA_TPTC1, 0x3) ;            
            DM6437_halPciPwrChangeState (halObject, LPSC_EDMA_TPTC2, 0x3) ;
        }
        break ;
                             ...
                             IN Uint16          state)
{
    ...
    TRC_3ENTER ("DM6437_halPciPwrChangeState", halObj, lpscNum, state) ;
    ...
    TRC_0LEAVE ("DM6437_halPciIntCtrl") ;
}
                         ...
                         IN Uint32          div2)
{
    ...
    TRC_4ENTER ("DM6437_halPciPwrCfgPLL1", halObj, pllm, div1, div2) ;

    pllRegs  = (DM6437_pllRegs *) (  halObject->pci.barVirt [CFG_REGS_BAR_NO]
                                   + DM6437_PLL1REG_BASE) ;
    /*  ------------------------------------------------------------------------
    ...
    TRC_0LEAVE ("DM6437_halPciPwrCfgPLL1") ;
}
...
DM6437_halPciPwrCfgDDR2 (IN Pvoid halObj, IN Uint32  freq)
{
    ...
    TRC_2ENTER ("DM6437_halPciPwrCfgPLL1", halObj, freq) ;

    devRegs  = (DM6437_devRegs *) (  halObject->pci.barVirt [CFG_REGS_BAR_NO]
                                   + DM6437_DEVREG_BASE) ;
    ddrRegs  = (DM6437_ddrRegs *) (  halObject->pci.barVirt [DDR_REGS_BAR_NO]
                                   + DM6437_DDRREG_BASE) ;

    vtpiocr  = (Uint32 *) (halObject->pci.barVirt [DDR_REGS_BAR_NO] + 0xF0) ;
    vtpr     = (Uint32 *) (halObject->pci.barVirt [CFG_REGS_BAR_NO] + 0x42038) ;
    dftEnb   = (Uint32 *) (halObject->pci.barVirt [CFG_REGS_BAR_NO] + 0x4004C) ;
    ...
    DM6437_halPciPwrChangeState (halObject, LPSC_DDR, 0x1) ;
    /* Enable the DDR2 PSC Module */
    DM6437_halPciPwrChangeState (halObject, LPSC_DDR, 0x3) ;
    ...
    *dftEnb   = 0 ;
    ...
    TRC_0LEAVE ("DM6437_halPciPwrCfgDDR2") ;
}
