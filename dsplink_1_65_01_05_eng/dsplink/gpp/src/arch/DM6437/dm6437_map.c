...
/** ============================================================================
 *  @name   DM6437_DspObjects
 *
 *  @desc   Array of configuration mapping objects for the DSPs in the system.
 *  ============================================================================
 */
EXTERN DSP_Interface    DM6437_Interface ;
CONST CFGMAP_Dsp  DM6437_DspObjects [] =
{
    {
        "DM6437",                   /* NAME           : Name of the DSP */
        &DM6437_Interface           /* INTERFACE      : DSP interface table */
    }
} ;

/** ============================================================================
 *  @name   DM6437_LoaderObjects
 *
...
CONST CFGMAP_Loader  DM6437_LoaderObjects [] =
{
    {
...
CONST CFGMAP_LinkDrv  DM6437_LinkDrvObjects [] =
{
    {
...
CONST CFGMAP_Ips  DM6437_IpsObjects [] =
{
    {
...
CONST CFGMAP_Pool  DM6437_PoolObjects [] =
{
    {
...
CONST CFGMAP_DataDrv  DM6437_DataDrvObjects [] =
{
    {
...
CONST CFGMAP_Mqt  DM6437_MqtObjects [] =
{
    {
...
/** ============================================================================
 *  @name   DM6437MAP_Config
 *
 *  @desc   DSP/BIOS LINK configuration mapping structure.
 *  ============================================================================
 */
CONST CFGMAP_Object  DM6437MAP_Config = {
    1,                                        /* NUMDSPS        : Number of types of DSPs */
    (CFGMAP_Dsp *)     DM6437_DspObjects,     /* DSPOBJECTS     : Array of DSP configuration mapping objects */
#if defined (OS_PROS)
    5,                                        /* NUMLOADERS     : Number of types of DSP executable loaders */
#else /* if defined (OS_PROS) */
    4,                                        /* NUMLOADERS     : Number of types of DSP executable loaders */
#endif /* if defined (OS_PROS) */
    (CFGMAP_Loader *)  DM6437_LoaderObjects,  /* LOADERS        : Array of DSP executable loader configuration mapping objects */

#if (!defined (ONLY_PROC_COMPONENT))
    1,                                        /* NUMLINKDRVS    : Number of types of link drivers */
    (CFGMAP_LinkDrv *) DM6437_LinkDrvObjects, /* LINKDRVOBJECTS : Array of Link Driver configuration mapping objects */
    1,                                        /* NUMIPS         : Number of types of IPS */
    (CFGMAP_Ips *)     DM6437_IpsObjects,     /* IPSOBJECTS     : Array of IPS configuration mapping objects */
#else
    ...
    (CFGMAP_Pool *)    DM6437_PoolObjects,    /* POOLOBJECTS    : Array of POOL configuration mapping objects */
#endif /* if defined (POOL_COMPONENT) */
#if defined (CHNL_COMPONENT)
    1,                                        /* NUMDATADRIVERS : Number of types of Data drivers */
    (CFGMAP_DataDrv *) DM6437_DataDrvObjects, /* DATADRIVERS    : Array of Data driver configuration mapping objects */
#endif /* if defined (CHNL_COMPONENT) */
#if defined (MSGQ_COMPONENT)
    1,                                        /* NUMMQTS        : Number of types of MQTs */
    (CFGMAP_Mqt *)     DM6437_MqtObjects      /* MQTOBJECTS     : Array of MQT configuration mapping objects */
#endif /* if defined (MSGQ_COMPONENT) */
} ;
