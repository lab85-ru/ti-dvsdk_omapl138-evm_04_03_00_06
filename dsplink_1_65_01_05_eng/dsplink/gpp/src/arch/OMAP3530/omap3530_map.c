...
/** ============================================================================
 *  @name   OMAP3530MAP_DspObjects
 *
 *  @desc   Array of configuration mapping objects for the DSPs in the system.
 *  ============================================================================
 */
EXTERN DSP_Interface    OMAP3530_Interface ;
CONST CFGMAP_Dsp  OMAP3530MAP_DspObjects [] =
{
    {
        "OMAP3530",                  /* NAME           : Name of the DSP */
        &OMAP3530_Interface          /* INTERFACE      : DSP interface table */
    }
} ;

/** ============================================================================
 *  @name   OMAP3530MAP_LoaderObjects
 *
...
CONST CFGMAP_Loader  OMAP3530MAP_LoaderObjects [] =
{
    {
...
/** ============================================================================
 *  @name   OMAP3530MAP_LinkDrvObjects
 *
...
CONST CFGMAP_LinkDrv  OMAP3530MAP_LinkDrvObjects [] =
{
    {
...
CONST CFGMAP_Ips  OMAP3530MAP_IpsObjects [] =
{
    {
...
CONST CFGMAP_Pool  OMAP3530MAP_PoolObjects [] =
{
    {
...
/** ============================================================================
 *  @name   OMAP3530MAP_DataDrvObjects
 *
...
CONST CFGMAP_DataDrv  OMAP3530MAP_DataDrvObjects [] =
{
    {
...
CONST CFGMAP_Mqt  OMAP3530MAP_MqtObjects [] =
{
    {
...
/** ============================================================================
 *  @name   OMAP3530MAP_Config
 *
 *  @desc   DSP/BIOS LINK configuration mapping structure.
 *  ============================================================================
 */
CFGMAP_Object  OMAP3530MAP_Config = {
    1,                                              /* NUMDSPS        : Number of types of DSPs */
    (CFGMAP_Dsp *)     OMAP3530MAP_DspObjects,     /* DSPOBJECTS     : Array of DSP configuration mapping objects */
    4,                                              /* NUMLOADERS     : Number of types of DSP executable loaders */
    (CFGMAP_Loader *)  OMAP3530MAP_LoaderObjects,  /* LOADERS        : Array of DSP executable loader configuration mapping objects */

#if (!defined (ONLY_PROC_COMPONENT))
    1,                                              /* NUMLINKDRVS    : Number of types of link drivers */
    (CFGMAP_LinkDrv *) OMAP3530MAP_LinkDrvObjects, /* LINKDRVOBJECTS : Array of Link Driver configuration mapping objects */
    1,                                              /* NUMIPS         : Number of types of IPS */
    (CFGMAP_Ips *)     OMAP3530MAP_IpsObjects,     /* IPSOBJECTS     : Array of IPS configuration mapping objects */
#else
    ...
    (CFGMAP_Pool *)    OMAP3530MAP_PoolObjects,    /* POOLOBJECTS    : Array of POOL configuration mapping objects */
#endif /* if defined (POOL_COMPONENT) */
#if defined (CHNL_COMPONENT)
    1,                                              /* NUMDATADRIVERS : Number of types of Data drivers */
    (CFGMAP_DataDrv *) OMAP3530MAP_DataDrvObjects, /* DATADRIVERS    : Array of Data driver configuration mapping objects */
#endif /* if defined (CHNL_COMPONENT) */
#if defined (MSGQ_COMPONENT)
    1,                                              /* NUMMQTS        : Number of types of MQTs */
    (CFGMAP_Mqt *)     OMAP3530MAP_MqtObjects      /* MQTOBJECTS     : Array of MQT configuration mapping objects */
#endif /* if defined (MSGQ_COMPONENT) */
} ;
