...
/** ============================================================================
 *  @name   OMAP2530MAP_DspObjects
 *
 *  @desc   Array of configuration mapping objects for the DSPs in the system.
 *  ============================================================================
 */
EXTERN DSP_Interface    OMAP2530_Interface ;
CONST CFGMAP_Dsp  OMAP2530MAP_DspObjects [] =
{
    {
        "OMAP2530",                  /* NAME           : Name of the DSP */
        &OMAP2530_Interface          /* INTERFACE      : DSP interface table */
    }
} ;

/** ============================================================================
 *  @name   OMAP2530MAP_LoaderObjects
 *
...
CONST CFGMAP_Loader  OMAP2530MAP_LoaderObjects [] =
{
    {
...
/** ============================================================================
 *  @name   OMAP2530MAP_LinkDrvObjects
 *
...
CONST CFGMAP_LinkDrv  OMAP2530MAP_LinkDrvObjects [] =
{
    {
...
CONST CFGMAP_Ips  OMAP2530MAP_IpsObjects [] =
{
    {
...
CONST CFGMAP_Pool  OMAP2530MAP_PoolObjects [] =
{
    {
...
/** ============================================================================
 *  @name   OMAP2530MAP_DataDrvObjects
 *
...
CONST CFGMAP_DataDrv  OMAP2530MAP_DataDrvObjects [] =
{
    {
...
CONST CFGMAP_Mqt  OMAP2530MAP_MqtObjects [] =
{
    {
...
/** ============================================================================
 *  @name   OMAP2530MAP_Config
 *
 *  @desc   DSP/BIOS LINK configuration mapping structure.
 *  ============================================================================
 */
CFGMAP_Object  OMAP2530MAP_Config = {
    1,                                              /* NUMDSPS        : Number of types of DSPs */
    (CFGMAP_Dsp *)     OMAP2530MAP_DspObjects,     /* DSPOBJECTS     : Array of DSP configuration mapping objects */
    4,                                              /* NUMLOADERS     : Number of types of DSP executable loaders */
    (CFGMAP_Loader *)  OMAP2530MAP_LoaderObjects,  /* LOADERS        : Array of DSP executable loader configuration mapping objects */

#if (!defined (ONLY_PROC_COMPONENT))
    1,                                              /* NUMLINKDRVS    : Number of types of link drivers */
    (CFGMAP_LinkDrv *) OMAP2530MAP_LinkDrvObjects, /* LINKDRVOBJECTS : Array of Link Driver configuration mapping objects */
    1,                                              /* NUMIPS         : Number of types of IPS */
    (CFGMAP_Ips *)     OMAP2530MAP_IpsObjects,     /* IPSOBJECTS     : Array of IPS configuration mapping objects */
#else
    ...
    (CFGMAP_Pool *)    OMAP2530MAP_PoolObjects,    /* POOLOBJECTS    : Array of POOL configuration mapping objects */
#endif /* if defined (POOL_COMPONENT) */
#if defined (CHNL_COMPONENT)
    1,                                              /* NUMDATADRIVERS : Number of types of Data drivers */
    (CFGMAP_DataDrv *) OMAP2530MAP_DataDrvObjects, /* DATADRIVERS    : Array of Data driver configuration mapping objects */
#endif /* if defined (CHNL_COMPONENT) */
#if defined (MSGQ_COMPONENT)
    1,                                              /* NUMMQTS        : Number of types of MQTs */
    (CFGMAP_Mqt *)     OMAP2530MAP_MqtObjects      /* MQTOBJECTS     : Array of MQT configuration mapping objects */
#endif /* if defined (MSGQ_COMPONENT) */
} ;
