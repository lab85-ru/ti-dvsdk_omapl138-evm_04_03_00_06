/** ============================================================================
 *  @file   dra44xgem_hal_intgen.c
 *
 *  @path   $(DSPLINK)/gpp/src/arch/DRA44XGEM/
 *
 *  @desc   Hardware Abstraction Layer for DRA44XGEM.
...
#include <dra44xgem_hal_intgen.h>
                      ...
                      IN OUT     Pvoid          arg)
{
    ...
    TRC_3ENTER ("DRA44XGEM_halIntCtrl", halObj, cmd, arg) ;
    ...
    switch (cmd) {
        ...
        {
            /* Do nothing here for DRA44XGEM Gem */
        }
        break ;
    ...
    TRC_1LEAVE ("DRA44XGEM_halIntCtrl", status) ;
