...
/** ============================================================================
 *  @name   DA8XXGEMMAP_DspObjects
 *
 *  @desc   Array of configuration mapping objects for the DSPs in the system.
 *  ============================================================================
 */
extern DSP_Interface    DA8XXGEM_Interface ;
CONST CFGMAP_Dsp  DA8XXGEMMAP_DspObjects [] =
{
    {
        "DA8XXGEM",                  /* NAME           : Name of the DSP */
        &DA8XXGEM_Interface          /* INTERFACE      : DSP interface table */
    }
} ;

/** ============================================================================
 *  @name   DA8XXGEMMAP_LoaderObjects
 *
...
CONST CFGMAP_Loader  DA8XXGEMMAP_LoaderObjects [] =
{
    {
...
/** ============================================================================
 *  @name   DA8XXGEMMAP_LinkDrvObjects
 *
...
CONST CFGMAP_LinkDrv  DA8XXGEMMAP_LinkDrvObjects [] =
{
    {
...
CONST CFGMAP_Ips  DA8XXGEMMAP_IpsObjects [] =
{
    {
...
CONST CFGMAP_Pool  DA8XXGEMMAP_PoolObjects [] =
{
    {
...
/** ============================================================================
 *  @name   DA8XXGEMMAP_DataDrvObjects
 *
...
CONST CFGMAP_DataDrv  DA8XXGEMMAP_DataDrvObjects [] =
{
    {
...
CONST CFGMAP_Mqt  DA8XXGEMMAP_MqtObjects [] =
{
    {
...
/** ============================================================================
 *  @name   DA8XXGEMMAP_Config
 *
 *  @desc   DSP/BIOS LINK configuration mapping structure.
 *  ============================================================================
 */
CFGMAP_Object  DA8XXGEMMAP_Config = {
    1,                                              /* NUMDSPS        : Number of types of DSPs */
    (CFGMAP_Dsp *)     DA8XXGEMMAP_DspObjects,     /* DSPOBJECTS     : Array of DSP configuration mapping objects */
#if defined (OS_PROS)
...
#endif /* if defined (OS_PROS) */
    (CFGMAP_Loader *)  DA8XXGEMMAP_LoaderObjects,  /* LOADERS        : Array of DSP executable loader configuration mapping objects */

#if (!defined (ONLY_PROC_COMPONENT))
    1,                                              /* NUMLINKDRVS    : Number of types of link drivers */
    (CFGMAP_LinkDrv *) DA8XXGEMMAP_LinkDrvObjects, /* LINKDRVOBJECTS : Array of Link Driver configuration mapping objects */
    1,                                              /* NUMIPS         : Number of types of IPS */
    (CFGMAP_Ips *)     DA8XXGEMMAP_IpsObjects,     /* IPSOBJECTS     : Array of IPS configuration mapping objects */
#else
    ...
    (CFGMAP_Pool *)    DA8XXGEMMAP_PoolObjects,    /* POOLOBJECTS    : Array of POOL configuration mapping objects */
#endif /* if defined (POOL_COMPONENT) */
#if defined (CHNL_COMPONENT)
    1,                                              /* NUMDATADRIVERS : Number of types of Data drivers */
    (CFGMAP_DataDrv *) DA8XXGEMMAP_DataDrvObjects, /* DATADRIVERS    : Array of Data driver configuration mapping objects */
#endif /* if defined (CHNL_COMPONENT) */
#if defined (MSGQ_COMPONENT)
    1,                                              /* NUMMQTS        : Number of types of MQTs */
    (CFGMAP_Mqt *)     DA8XXGEMMAP_MqtObjects      /* MQTOBJECTS     : Array of MQT configuration mapping objects */
#endif /* if defined (MSGQ_COMPONENT) */
} ;
