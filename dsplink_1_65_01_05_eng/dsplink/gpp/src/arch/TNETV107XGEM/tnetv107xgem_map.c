...
/** ============================================================================
 *  @name   TNETV107XGEMMAP_DspObjects
 *
 *  @desc   Array of configuration mapping objects for the DSPs in the system.
 *  ============================================================================
 */
EXTERN DSP_Interface    TNETV107XGEM_Interface ;
CONST CFGMAP_Dsp  TNETV107XGEMMAP_DspObjects [] =
{
    {
        "TNETV107XGEM",                  /* NAME           : Name of the DSP */
        &TNETV107XGEM_Interface          /* INTERFACE      : DSP interface table */
    }
} ;

/** ============================================================================
 *  @name   TNETV107XGEMMAP_LoaderObjects
 *
...
CONST CFGMAP_Loader  TNETV107XGEMMAP_LoaderObjects [] =
{
    {
...
/** ============================================================================
 *  @name   TNETV107XGEMMAP_LinkDrvObjects
 *
...
CONST CFGMAP_LinkDrv  TNETV107XGEMMAP_LinkDrvObjects [] =
{
    {
...
/** ============================================================================
 *  @name   TNETV107XGEMMAP_IpsObjects
 *
...
CONST CFGMAP_Ips  TNETV107XGEMMAP_IpsObjects [] =
{
    {
...
#if defined (POOL_COMPONENT)
/** ============================================================================
 *  @name   TNETV107XGEMMAP_PoolObjects
 *
...
CONST CFGMAP_Pool  TNETV107XGEMMAP_PoolObjects [] =
{
    {
...
/** ============================================================================
 *  @name   TNETV107XGEMMAP_DataDrvObjects
 *
...
CONST CFGMAP_DataDrv  TNETV107XGEMMAP_DataDrvObjects [] =
{
    {
...
#if defined (MSGQ_COMPONENT)
/** ============================================================================
 *  @name   TNETV107XGEMMAP_MqtObjects
 *
...
CONST CFGMAP_Mqt  TNETV107XGEMMAP_MqtObjects [] =
{
    {
...
/** ============================================================================
 *  @name   TNETV107XGEMMAP_Config
 *
 *  @desc   DSP/BIOS LINK configuration mapping structure.
 *  ============================================================================
 */
CFGMAP_Object  TNETV107XGEMMAP_Config = {
    1,                                              /* NUMDSPS        : Number of types of DSPs */
    (CFGMAP_Dsp *)     TNETV107XGEMMAP_DspObjects,     /* DSPOBJECTS     : Array of DSP configuration mapping objects */
#if defined (OS_PROS)
...
#endif /* if defined (OS_PROS) */
    (CFGMAP_Loader *)  TNETV107XGEMMAP_LoaderObjects,  /* LOADERS        : Array of DSP executable loader configuration mapping objects */

#if (!defined (ONLY_PROC_COMPONENT))
    1,                                              /* NUMLINKDRVS    : Number of types of link drivers */
    (CFGMAP_LinkDrv *) TNETV107XGEMMAP_LinkDrvObjects, /* LINKDRVOBJECTS : Array of Link Driver configuration mapping objects */
    1,                                              /* NUMIPS         : Number of types of IPS */
    (CFGMAP_Ips *)     TNETV107XGEMMAP_IpsObjects,     /* IPSOBJECTS     : Array of IPS configuration mapping objects */
#else
    ...
    (CFGMAP_Pool *)    TNETV107XGEMMAP_PoolObjects,    /* POOLOBJECTS    : Array of POOL configuration mapping objects */
#endif /* if defined (POOL_COMPONENT) */
#if defined (CHNL_COMPONENT)
    1,                                              /* NUMDATADRIVERS : Number of types of Data drivers */
    (CFGMAP_DataDrv *) TNETV107XGEMMAP_DataDrvObjects, /* DATADRIVERS    : Array of Data driver configuration mapping objects */
#endif /* if defined (CHNL_COMPONENT) */
#if defined (MSGQ_COMPONENT)
    1,                                              /* NUMMQTS        : Number of types of MQTs */
    (CFGMAP_Mqt *)     TNETV107XGEMMAP_MqtObjects      /* MQTOBJECTS     : Array of MQT configuration mapping objects */
#endif /* if defined (MSGQ_COMPONENT) */
} ;
