...
/** ============================================================================
 *  @name   DRX416GEM_DspObjects
 *
 *  @desc   Array of configuration mapping objects for the DSPs in the system.
 *  ============================================================================
 */
extern DSP_Interface DRX416GEM_Interface ;
CONST CFGMAP_Dsp DRX416GEM_DspObjects [] =
{
    {
        "DRX416GEM",                     /* NAME      : Name of the DSP */
        &DRX416GEM_Interface             /* INTERFACE : DSP interface table */
    }
} ;

/** ============================================================================
 *  @name   DRX416GEM_LoaderObjects
 *
...
CONST CFGMAP_Loader  DRX416GEM_LoaderObjects [] =
{
    {
...
CONST CFGMAP_LinkDrv  DRX416GEM_LinkDrvObjects [] =
{
    {
...
CONST CFGMAP_Pool  DRX416GEM_PoolObjects [] =
{
    {
...
CONST CFGMAP_DataDrv  DRX416GEM_DataDrvObjects [] =
{
    {
...
CONST CFGMAP_Mqt  DRX416GEM_MqtObjects [] =
{
    {
...
/** ============================================================================
 *  @name   DRX416GEM_Config
 *
 *  @desc   DSP/BIOS LINK configuration mapping structure.
 *  ============================================================================
 */
CONST CFGMAP_Object  DRX416GEMMAP_Config = {
    1u,                                          /* NUMDSPS        : Number of types of DSPs */
    (CFGMAP_Dsp *)     DRX416GEM_DspObjects,     /* DSPOBJECTS     : Array of DSP configuration mapping objects */
#if defined (OS_PROS)
    6,                                        /* NUMLOADERS     : Number of types of DSP executable loaders */
#else /* if defined (OS_PROS) */
    4,                                        /* NUMLOADERS     : Number of types of DSP executable loaders */
#endif /* if defined (OS_PROS) */
    (CFGMAP_Loader *)  DRX416GEM_LoaderObjects,  /* LOADERS        : Array of DSP executable loader configuration mapping objects */

#if (!defined (ONLY_PROC_COMPONENT))
    1u,                                          /* NUMLINKDRVS    : Number of types of link drivers */
    (CFGMAP_LinkDrv *) DRX416GEM_LinkDrvObjects, /* LINKDRVOBJECTS : Array of Link Driver configuration mapping objects */
    1u,                                          /* NUMIPS         : Number of types of IPS */
    (CFGMAP_Ips *)     DRX416GEM_IpsObjects,     /* IPSOBJECTS     : Array of IPS configuration mapping objects */
#else
    ...
    (CFGMAP_Pool *)    DRX416GEM_PoolObjects,    /* POOLOBJECTS    : Array of POOL configuration mapping objects */
#endif /* if defined (POOL_COMPONENT) */
#if defined (CHNL_COMPONENT)
    1u,                                          /* NUMDATADRIVERS : Number of types of Data drivers */
    (CFGMAP_DataDrv *) DRX416GEM_DataDrvObjects, /* DATADRIVERS    : Array of Data driver configuration mapping objects */
#endif /* if defined (CHNL_COMPONENT) */
#if defined (MSGQ_COMPONENT)
    1u,                                          /* NUMMQTS        : Number of types of MQTs */
    (CFGMAP_Mqt *)     DRX416GEM_MqtObjects      /* MQTOBJECTS     : Array of MQT configuration mapping objects */
#endif /* if defined (MSGQ_COMPONENT) */
} ;
