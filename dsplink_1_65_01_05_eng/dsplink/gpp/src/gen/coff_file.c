 ...
 *
 *  @desc   Implements the file-based DSP COFF loader.
 *
 *  @ver    1.65.01.05_eng
 *  ============================================================================
 ...
 *  ============================================================================
 */
#define  COMPONENT_ID         ID_GEN_COFF_FILE
...
#define  SET_FAILURE_REASON   TRC_SetReason (status, FID_C_GEN_COFF_FILE, __LINE__)
#else
...
/** ============================================================================
 *  @name   COFFFILE_Interface
 *
 *  @desc   Interface table for file-based COFF loader.
 *  ============================================================================
 */
LOADER_Interface COFFFILE_Interface = {
    &COFFFILE_init,
    &COFFFILE_exit,
    &COFF_load,
    &COFF_loadSection,
