 ...
 *  @func   COFFSHM_exit
 *
 *  @desc   Deallocates the object(s) created by COFFSHM_init function and
 *          releases the context.
 *
 *  @arg    objCtx
 *              The context object obtained through COFFSHM_init.
 *
 *  @ret    DSP_SOK
 *              Operation successfully completed.
 *          DSP_EFILE
