...
#if !defined (DM6437_HAL_PCI_PWR_H)
#define DM6437_HAL_PCI_PWR_H
...
NORMAL_API
DSP_STATUS
DM6437_halPciPwrCtrl (IN         Pvoid          halObject,
...
#endif /* !defined (DM6437_HAL_PCI_PWR_H) */
