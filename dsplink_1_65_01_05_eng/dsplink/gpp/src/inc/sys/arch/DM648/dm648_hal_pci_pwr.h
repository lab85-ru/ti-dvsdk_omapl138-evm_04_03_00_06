...
#if !defined (DM648_HAL_PCI_PWR_H)
#define DM648_HAL_PCI_PWR_H
...
NORMAL_API
DSP_STATUS
DM648_halPciPwrCtrl (IN         Pvoid          halObject,
...
#endif /* !defined (DM648_HAL_PCI_PWR_H) */
