 ...
 *  ----------------------------------------------------------------------------
 */
/* In case of shared INT, if the device has not generated INT, then it must
 * return this error code, so that we can say that INT was not generated by
 * us and pass IRQ_NONE to linux.
 */
